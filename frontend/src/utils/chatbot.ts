...
const intents: Intent[] = [
  // Greetings & General (low specificity)
  {
    ...
    specificity: 2,
    response: "Hey there! 👋 So glad you stopped by. I'm here to help you find the perfect piece from our handcrafted oxidized silver collection — whether you're browsing for yourself or looking for a gift. What can I help you with today?",
    quickReplies: [
  ...
  // 💍 Product Related Questions
  {
    ...
    specificity: 7,
    response: "Oh, our rings are some of my personal favourites! 😍 Each one is handcrafted with intricate details and that gorgeous darkened oxidized finish that makes them really stand out. They look stunning for everyday wear and special occasions alike. Want to take a look at the full collection?",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 7,
    response: "Great taste! Our necklaces and pendants are truly something special — we have everything from dainty, delicate chains to bold statement pieces, all in oxidized silver. The craftsmanship on each one is really beautiful. Shall I take you to the shop so you can see them for yourself?",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 7,
    response: "Love that you're looking at bracelets! Ours range from delicate, everyday chains to bold cuffs and bangles — all handcrafted in oxidized silver. The best part? They actually get more beautiful with wear as they develop their own unique character. Want to explore the designs?",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 7,
    response: "Earrings are such a great choice! We have everything from subtle, everyday studs to elegant drop designs that really make a statement. They're all lightweight and comfortable for all-day wear, crafted in oxidized silver. Would you like to see them?",
    quickReplies: [
  ...
  },
  {
    ...
    response: "Oh, I'd love to show you what we have! 🌙 We specialize in handcrafted oxidized silver jewelry — rings, pendants, necklaces, bracelets, earrings, and more. Every piece has that signature darkened finish that really brings out the intricate details. Is there a particular type of piece you're drawn to?",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 6,
    response: "Great question! Prices vary by piece depending on the design complexity and materials used — you'll find each item's price listed right in the shop. We really believe in fair pricing for handcrafted quality that's built to last. Want to browse and see what catches your eye?",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 6,
    response: "You're in for a treat! Our current collection is full of beautiful handcrafted oxidized silver pieces — each one unique and made with real attention to detail. Head over to the shop to see everything we have available right now. I think you'll find something you love!",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 6,
    response: "Such a thoughtful question! Our jewelry is designed to be timeless and versatile — many pieces are unisex, and we have designs that suit a wide range of styles and preferences. What type of piece are you thinking about? I'd love to help you find the right fit!",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 6,
    response: "Honestly, it's hard to pick just one — our customers love so many different pieces! That said, for everyday elegance, our rings and stud earrings are always a hit. For something more special, our statement pendants and drop earrings are stunning. What's the occasion? I can help narrow it down!",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 8,
    response: "How exciting — congratulations! 🎉 Our oxidized silver jewelry makes for truly unique and beautiful bridal pieces. The vintage aesthetic adds so much character to a wedding look. For specific bridal requests or custom designs, I'd really recommend reaching out to us directly so we can help bring your vision to life!",
    quickReplies: [
  ...
  // 📏 Size & Customization
  {
    ...
    specificity: 7,
    response: "Getting the right fit is so important — I totally understand! For rings, you can measure your finger circumference or use a ring sizer. For bracelets, just measure around your wrist. For necklaces, we offer standard lengths. Not sure? No worries — our team is happy to walk you through it!",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 8,
    response: "Oh, we absolutely love making something special for someone! 💛 While our current collection has a lot of beautiful ready-made designs, we're always happy to chat about custom requests and personalization. What did you have in mind? Drop us a message and let's explore the possibilities together!",
    quickReplies: [
  ...
  // 💰 Pricing & Offers
  {
    ...
    specificity: 7,
    response: "Who doesn't love a good deal, right? 😄 We do run special promotions from time to time! The best way to stay in the loop is to check our shop regularly or get in touch with us to be added to our mailing list. Is there something specific you're eyeing?",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 9,
    response: "Totally understandable — we want to make it as easy as possible for you! Payment options, including installments, can be discussed when we confirm your order. We work with each customer individually to find an arrangement that works for you. Want to go ahead and submit an order request?",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 9,
    response: "No hidden fees here — promise! 🙌 Our prices include everything: crafting, materials, the works. The price you see is the complete price. We really believe in keeping things transparent and straightforward for our customers.",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 8,
    response: "Great question! Tax details are confirmed when you place your order — applicable taxes will be clearly communicated based on your location. We always make sure everything is fully transparent so there are no surprises at checkout.",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 8,
    response: "Ooh, festive shopping — love it! 🎊 We do sometimes offer special promotions during festivals and holidays. Keep an eye on our shop or reach out to us directly to stay in the know about any upcoming sales or special offers. It's always worth checking!",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 8,
    response: "We ship to quite a few locations! Just reach out to us with your specific location and we'll confirm the shipping options, timelines, and costs for you. We want to make sure your jewelry reaches you safely, no matter where you are! 🌍",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 9,
    response: "Shipping costs depend on your location and order size — we'll give you the exact amount when you submit your order request, so no surprises! Rest assured, we pack everything really carefully to make sure it arrives safely and beautifully.",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 9,
    response: "Once your order ships, we'll send tracking information straight to your email so you can keep an eye on your package every step of the way. If you have any questions about your order in the meantime, just reach out — we're always happy to help!",
    quickReplies: [
      { id: 'q60', text: 'Contact us', intent: 'navigate-contact' },
      { id: 'q61', text: 'Order tracking info', intent: 'navigate-order-tracking' },
    ],
  },
  {
    keywords: ['packaging', 'package', 'box', 'gift wrap', 'gift box', 'wrapped'],
    phrases: ['gift packaging', 'gift wrap', 'how is it packaged'],
    specificity: 8,
    response: "Every order is packaged with real care and attention — we want the unboxing experience to feel special! If you're sending it as a gift, just let us know when you place your order and we'll make sure it's presented beautifully. 🎁",
    quickReplies: [
  ...
  // 🔄 Returns & Exchanges
  {
    keywords: ['return', 'returns', 'refund', 'exchange', 'replace', 'replacement', 'money back'],
    phrases: ['return policy', 'can I return', 'exchange policy', 'refund policy'],
    specificity: 8,
    response: "I completely understand wanting to know this before you buy! We do have a return and exchange policy in place. For the full details, please check our Returns page or reach out to us directly — we always want to make sure you're happy with your purchase.",
    quickReplies: [
  ...
  },
  {
    ...
    phrases: ['received damaged', 'item broken', 'wrong order', 'defective item'],
    specificity: 9,
    response: "Oh no, I'm so sorry to hear that! That's definitely not the experience we want for you. Please reach out to us right away with your order details and a photo if possible — we'll make it right for you as quickly as we can. 💙",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 9,
    response: "Good question — and honestly, it's best to keep your oxidized silver jewelry away from water when you can. Prolonged exposure to water can affect the oxidized finish over time. So I'd recommend taking it off before swimming or showering. A little care goes a long way in keeping it looking gorgeous! 💧",
    quickReplies: [
  ...
  // 🔬 Materials & Quality
  {
    keywords: ['material', 'materials', 'silver', 'sterling', 'quality', 'metal', 'alloy', 'composition'],
    phrases: ['what material', 'made of', 'silver quality', 'sterling silver'],
    specificity: 7,
    response: "We use only premium sterling silver — that's 92.5% pure silver — for all our pieces. The oxidized finish is a professional treatment that creates the beautiful darkened patina you see. It's not a coating or plating; it's a chemical process that becomes part of the metal itself. Real quality, through and through! 🌟",
    quickReplies: [
  ...
  {
    keywords: ['hallmark', 'certified', 'certification', 'stamp', 'bis', 'hallmarked'],
    phrases: ['is it hallmarked', 'certification details', 'quality certification'],
    specificity: 9,
    response: "Great question — quality matters! For specific details about hallmarking and certifications on our pieces, please reach out to us directly. We're happy to provide all the information you need to feel confident in your purchase.",
    quickReplies: [
  ...
  // 🛒 Ordering Process
  {
    keywords: ['order', 'buy', 'purchase', 'checkout', 'cart', 'add to cart', 'how to order'],
    phrases: ['how to buy', 'place an order', 'how to order', 'ordering process'],
    specificity: 6,
    response: "Ordering is really simple! Browse our shop, add the pieces you love to your cart, and then submit an order request with your details. Since we're a boutique, we confirm each order personally — no automated checkout. We'll be in touch to confirm everything and arrange payment. Ready to get started?",
    quickReplies: [
  ...
  {
    keywords: ['payment', 'pay', 'upi', 'card', 'cash', 'bank transfer', 'online payment'],
    phrases: ['payment methods', 'how to pay', 'payment options', 'accepted payments'],
    specificity: 8,
    response: "We offer flexible payment options! The specific methods available are confirmed when we process your order — we work with each customer to find what's most convenient. Just submit an order request or reach out to us and we'll sort it all out together.",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 9,
    response: "Cash on delivery availability depends on your location and order details. When you submit your order request, we'll confirm what payment options are available for you — we always try to be as flexible as possible!",
    quickReplies: [
  ...
  },
  {
    ...
    specificity: 9,
    response: "If you need to cancel an order, please reach out to us as soon as possible — the sooner we know, the easier it is to sort out. We'll do our best to accommodate your request and make the process as smooth as possible for you.",
    quickReplies: [
  ...
  // 🎁 Gifting
  {
    keywords: ['gift', 'gifting', 'present', 'birthday', 'anniversary', 'surprise'],
    phrases: ['as a gift', 'gift for her', 'gift for him', 'birthday gift', 'anniversary gift'],
    specificity: 7,
    response: "Aww, jewelry makes the most thoughtful gift! 🎁 Our oxidized silver pieces are really special — they feel personal and unique in a way that mass-produced jewelry just doesn't. For birthdays, anniversaries, or just because — we can help you find the perfect piece. What's the occasion and who's it for?",
    quickReplies: [
  ...
  // 🏪 About the Brand
  {
    keywords: ['about', 'story', 'brand', 'who are you', 'lunara', 'company', 'founder', 'history'],
    phrases: ['about lunara', 'your story', 'who makes', 'brand story'],
    specificity: 6,
    response: "I love talking about this! 🌙 Lunara Jewels is a boutique jewelry brand with a real passion for handcrafted oxidized silver. Every piece is made with care and intention — we're not a factory, we're artisans. Want to learn more about our story and what drives us?",
    quickReplies: [
  ...
  {
    keywords: ['store', 'physical store', 'visit', 'showroom', 'walk in', 'offline'],
    phrases: ['physical store', 'visit your store', 'come to your shop', 'offline store'],
    specificity: 8,
    response: "We're currently an online-only boutique — no physical storefront just yet! But don't worry, we're very hands-on and personal in how we work with customers. You can reach us anytime through our Contact page and we'll give you the same attentive service you'd get in person. 😊",
    quickReplies: [
  ...
  {
    keywords: ['contact', 'reach', 'email', 'phone', 'call', 'whatsapp', 'message', 'support', 'help'],
    phrases: ['how to contact', 'get in touch', 'reach you', 'customer support'],
    specificity: 6,
  ...
  // ⭐ Reviews & Trust
  {
    keywords: ['review', 'reviews', 'testimonial', 'feedback', 'rating', 'customer review'],
    phrases: ['customer reviews', 'what do customers say', 'read reviews'],
    specificity: 7,
    response: "We're so proud of the love our customers show us! 💛 Our pieces have made a lot of people really happy — from everyday wearers to gift-givers. Want to read what our customers have to say? I can take you to our reviews page!",
    quickReplies: [
  ...
  // ❓ Fallback
  {
    keywords: ['help', 'question', 'info', 'information', 'know', 'tell', 'explain', 'what', 'how', 'why', 'when', 'where'],
    specificity: 1,
    response: "I'm here to help! 😊 I can answer questions about our jewelry, materials, sizing, shipping, ordering, and more. What would you like to know? If your question is a bit more complex, our team is always just a message away on the Contact page.",
    quickReplies: [
...
const fallbackResponse = {
  response: "Hmm, I'm not quite sure I caught that — sorry about that! 😅 I'm best at answering questions about our jewelry, materials, sizing, shipping, and ordering. Could you try rephrasing, or pick one of the options below? And if you need something more specific, our team is always happy to help on the Contact page!",
  quickReplies: [
...
export function getBotResponse(userInput: string): { response: string; quickReplies: QuickReply[] } {
  if (!userInput.trim()) {
