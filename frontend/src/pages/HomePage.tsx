      ...
      <section className="relative h-[600px] md:h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container text-center space-y-6 px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 animate-fade-in">
            ...
            <Button asChild variant="outline" size="lg" className="text-base bg-white/10 border-white/60 text-white hover:bg-white/20 hover:text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-none shadow-elegant">
              <CardContent className="pt-8 text-center space-y-4">
                ...
                <h3 className="font-serif text-xl font-semibold text-foreground">Handcrafted Excellence</h3>
            ...
            <Card className="border-none shadow-elegant">
              <CardContent className="pt-8 text-center space-y-4">
                ...
                <h3 className="font-serif text-xl font-semibold text-foreground">Timeless Design</h3>
                <p className="text-foreground/70">
            ...
            <Card className="border-none shadow-elegant">
              <CardContent className="pt-8 text-center space-y-4">
                ...
                <h3 className="font-serif text-xl font-semibold text-foreground">Authentic Materials</h3>
                <p className="text-foreground/70">
