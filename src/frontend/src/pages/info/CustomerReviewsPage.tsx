    ...
    <div className="container max-w-5xl py-12 md:py-16">
      <div className="mb-12 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Hear from our customers about their experience with Lunara Jewels
          handcrafted oxidized silver jewelry.
        </p>
      </div>
      ...
      <Alert className="mb-8">
        ...
        <AlertDescription>
          These testimonials represent the experiences shared by our customers.
          We&apos;re grateful for every piece of feedback and strive to provide
          exceptional quality and service to everyone.
        </AlertDescription>
      </Alert>
              ...
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="flex gap-0.5">
                  {Array.from({ length: testimonial.rating }).map((_, i) => (
                    <Star
                      // biome-ignore lint/suspicious/noArrayIndexKey: star rating items
                      key={i}
      ...
      <Card className="bg-muted/30">
        <CardContent className="pt-6 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            We&apos;d love to hear about your experience with Lunara Jewels!
