      ...
      <div className="space-y-6">
        <Card>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            <p>
              Lunara Jewels ("we," "our," or "us") respects your privacy and is
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                ...
                number, and shipping address when you submit order requests or
                contact forms
              </li>
              <li>
                <strong>Order Information:</strong> Details about products
                you're interested in, quantities, and any special requests or
                customization notes
              </li>
              <li>
                <strong>Communication Records:</strong> Messages you send
                through our contact form or chat feature
              </li>
              <li>
                <strong>Technical Information:</strong> Browser type, device
                information, and IP address (collected automatically through
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                Communicate with you about your orders, inquiries, and requests
              </li>
              <li>Provide customer support and respond to your questions</li>
              <li>
                Send you order confirmations, shipping updates, and tracking
                information
              </li>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                ...
                processing payments, or shipping orders (e.g., shipping
                carriers)
              </li>
              <li>
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <p>
              ...
              credit card numbers) on our website. Payment details are handled
              through secure, trusted payment channels arranged individually
              with each customer.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            <p>
              Our website uses local storage to maintain your shopping cart
              across sessions. We do not use third-party tracking cookies or
              analytics services that collect personal information.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            <p>
              ...
              data practices, please contact us through our Contact page or chat
              feature.
            </p>
          </CardContent>
        </Card>
