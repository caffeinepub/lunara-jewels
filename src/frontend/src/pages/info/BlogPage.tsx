...
import { Droplets, Gift, Heart, Sparkles } from "lucide-react";
  ...
  const posts = [
    {
      ...
      description:
        "Learn how to maintain the beauty and character of your oxidized silver pieces with proper care and storage.",
      content: [
    ...
    },
    {
      ...
      description:
        "Discover how to incorporate oxidized silver jewelry into your everyday style and special occasion looks.",
      content: [
    ...
    },
    {
      ...
      description:
        "Why oxidized silver makes a thoughtful, unique gift for any occasion.",
      content: [
    ...
    },
    {
      ...
      description:
        "Understanding the art and technique of oxidized silver jewelry making.",
      content: [
    ...
    <div className="container max-w-5xl py-12 md:py-16">
      <div className="mb-12 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Explore the world of oxidized silver jewelry with care tips, styling
          ideas, and insights into our craft.
        </p>
      </div>
      ...
      <div className="space-y-8 mb-12">
        {posts.map((post, index) => {
          ...
          return (
            // biome-ignore lint/suspicious/noArrayIndexKey: static blog post list
            <Card key={index}>
              <CardHeader>
              ...
              <CardContent>
                <div className="space-y-3 text-muted-foreground">
                  {post.content.map((paragraph, pIndex) => (
                    // biome-ignore lint/suspicious/noArrayIndexKey: static blog paragraphs
      ...
      <div className="bg-muted/30 rounded-lg p-8 text-center">
        ...
        <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
          Discover handcrafted oxidized silver jewelry that combines timeless
          beauty with modern style.
        </p>
