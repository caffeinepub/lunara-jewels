    ...
    <div className="container max-w-4xl py-12 md:py-16">
      <div className="mb-12 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Find answers to common questions about our oxidized silver jewelry,
      ...
      <div className="space-y-8 mb-12">
        {faqCategories.map((category, categoryIndex) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: static FAQ list with no stable id
      ...
      <div className="bg-muted/30 rounded-lg p-8 text-center">
        ...
        <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
          ...
          Reach out through our contact form or chat with us directly.
        </p>
