...
import type { OrderRequest as _OrderRequest, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async listOrderRequests(): Promise<Array<OrderRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.listOrderRequests();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitOrderRequest(arg0: string, arg1: string, arg2: string, arg3: Array<CartItem>, arg4: bigint): Promise<bigint> {
        if (this.processError) {
            try {
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OrderRequest]): OrderRequest | null {
    return value.length === 0 ? null : value[0];
}
